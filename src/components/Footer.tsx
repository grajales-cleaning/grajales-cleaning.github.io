        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:items-center">
          <div className="flex flex-col items-center text-center">
            ...
            <p className="text-gray-300 mb-6 max-w-md">
              Professional house cleaning and office cleaning services for residential and commercial properties in Louisville, KY. 
              Trusted by homeowners and businesses throughout Kentucky for over a decade.
            </p>
